...
async def start(event):
    ...
    if not event.is_private:
        return await event.respond("ɪ ᴀᴍ 𝙎𝙄𝙉𝘼𝙈𝙄𝙆𝘼 💞")
    await event.reply(
        "━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ɪ ᴀᴍ |🦋 𝙎𝙄𝙉𝘼𝙈𝙄𝙆𝘼 🦋| ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴛʜᴇ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ\n✪ ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ʀᴜɴ /help..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ : [ɪ ᴢ ᴢ ʏ ʏ ɪ ʀ](https://t.me/bot_king_izzy)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [sinamika](https://t.me/BotSuppoort)┓\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/bot_king_izzy) ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━",
        link_preview=False,
        buttons=(
            [
                Button.url(
                    "🦋 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ 🦋",
                    "http://t.me/c_w_mention_Bot?startgroup=true",
                ),
            ],
            [
                Button.url("🦋 ɢʀᴏᴜᴘ 🦋", "https://t.me/Crazyworld_tamilchat"),
                Button.url("🦋 ᴄʜᴀɴɴᴇʟ 🦋", "https://t.me/MiNe_Dpz"),
            ],
            [
                Button.url("🦋 ʙʀᴏ 🦋", "https://t.me/Call_Me_Mr_Stoner"),
                Button.url("🦋 ɪᴢᴢʏ ɴᴇᴛᴡᴏʀᴋ 🦋", "https://t.me/izzyyir_bots"),
            ],
        ),
    )
...
async def help(event):
    ...
    if not event.is_private:
        return await event.respond("ᴅᴇᴀʀ sᴛᴀʀᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴғ 🥺")
    helptext = "✪ ᴏᴡɴᴇʀ ᴍᴇɴᴜ ᴏғ sɪɴᴀᴍɪᴋᴀ\n\n✪ ᴍʏ ᴏᴡɴᴇʀ ɪs [ɪ ᴢ ᴢ ʏ ʏ ɪ ʀ](https://t.me/bot_king_Izzy)\n✪ ᴏғғɪᴄɪᴀʟ ᴍᴇᴍʙᴇʀ ᴏғ ʀᴏᴄᴋs\n✪ [ɴᴇᴛᴡᴏʀᴋ]https://t.me/https://t.me/izzyyir_bots\n✪ ғᴜᴛᴜʀᴇ ᴀɴᴇsᴛʜᴇᴛɪᴄ."
    await event.reply(
        helptext,
        link_preview=False,
        buttons=(
